<input type="hidden" id="lokasi_url" value="<?php echo e(($mode == 'create') ? 'verif_permintaan/create' : 'verif_permintaan/edit'); ?>">
...
?>
<h3 class="text-primary mb-4">Verifikasi Permintaan Barang</h3>
<div class="row mb-2">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-block">
                <div class="card-header">
                    <h3>Form Verifikasi Permintaan Barang</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo e(base_url('verif_permintaan')); ?>" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.btn-ubah').click(function(){
                let confir = confirm('verifikasi data');
                if (confir === true) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(base_url('verif_permintaan/verif_detail_barang')); ?>",
                        data: data,
                        success: function (msg) { 
                            if(msg == 'sukses'){
                                alert('verifikasi berhasil');
                                window.location.href="<?php echo e(base_url().'verif_permintaan/'.$url_simpan_detail); ?>";
                            }else{
            ...
            $("#btnSimpanTransaksi").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(base_url('verif_permintaan/simpan_verif')); ?>",
                    data: data,
                    success: function (msg) { 
                        if(msg == 'sukses'){
                            alert('berhasil disimpan');
                            window.location.href="<?php echo e(base_url('verif_permintaan')); ?>";
                        }else{
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\persediaan-bpom5\application\views/verif_permintaan/form.blade.php ENDPATH**/ ?>