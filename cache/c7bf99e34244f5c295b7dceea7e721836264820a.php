							...
							<tbody>
								...
								<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td width="200px">
											<?php if($r->status == 0): ?>
												<a href="<?php echo e(base_url('verif_permintaan/edit').'?id='.$r->id_barang_keluar); ?>" class="btn btn-small btn-info"><i class="fa fa-edit"></i> Verifikasi</a>
											<?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\persediaan-bpom5\application\views/verif_permintaan/table.blade.php ENDPATH**/ ?>